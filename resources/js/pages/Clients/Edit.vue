...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: __('common.edit'), href: '/clients/' + props.client.id + '/edit' },
];
</script>

<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="__('clients.form.edit_title')" />

        <div class="px-4 py-6">
            <Heading :title="__('clients.form.edit_title')" :description="__('clients.form.edit_description', { name: client.company_name })" />
