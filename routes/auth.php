...
Route::middleware('guest')->group(function () {
    // Public registration is closed by default (single-user app). These routes
    // are always registered so route('register') resolves, but the middleware
    // 404s them unless REGISTRATION_ENABLED=true. See config/features.php.
